...
export default {
  ...
  computed: {
    ...
    ...mapState('chartCandles', ['lastOhlc', 'ohlc', 'ohlcX5', 'ohlcX25', 'ohlcX125', 'chart1AxisXMaximum', 'chart2AxisXMaximum', 'chart3AxisXMaximum', 'displayedTimeframes']),
  ...
  methods:
    {
      ...mapMutations('chartCandles', ['setmaxPort', 'connectSignalR', 'disconnectSignalr']),
      ...mapActions('chartCandles', ['loadCandles']),
